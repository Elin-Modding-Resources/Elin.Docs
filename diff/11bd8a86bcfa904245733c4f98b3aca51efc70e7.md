...
editLink: false
lastUpdated: false
description: 47 files modified. 2 new files created.
...
47 files modified. 2 new files created.
## ABILITY

[`@@ -4,6 +4,8 @@ public class ABILITY`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ABILITY.cs#L4)
```cs:line-numbers=4
{
...
[`@@ -30,11 +32,11 @@ public class ABILITY`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ABILITY.cs#L30)
```cs:line-numbers=30
...
[`@@ -62,15 +64,15 @@ public class ABILITY`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ABILITY.cs#L62)
```cs:line-numbers=62
...
[`@@ -98,11 +100,11 @@ public class ABILITY`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ABILITY.cs#L98)
```cs:line-numbers=98
...
[`@@ -130,15 +132,13 @@ public class ABILITY`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ABILITY.cs#L130)
```cs:line-numbers=130
...
[`@@ -158,10 +158,10 @@ public class ABILITY`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ABILITY.cs#L158)
```cs:line-numbers=158
...
[`@@ -178,19 +178,19 @@ public class ABILITY`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ABILITY.cs#L178)
```cs:line-numbers=178
...
[`@@ -202,11 +202,13 @@ public class ABILITY`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ABILITY.cs#L202)
```cs:line-numbers=202
...
[`@@ -224,24 +226,22 @@ public class ABILITY`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ABILITY.cs#L224)
```cs:line-numbers=224
...
[`@@ -379,6 +379,10 @@ public void ModAltitude(int a)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/AM_Build.cs#L379)
```cs:line-numbers=379
...
[`@@ -2206,7 +2206,7 @@ public static bool Wish(string s, string name, int power)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ActEffect.cs#L2206)
...
[`@@ -62,6 +62,7 @@ public bool CanSleepBeside()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Affinity.cs#L62)
```cs:line-numbers=62
...
[`@@ -73,7 +74,7 @@ public Thing OnGift(Thing t)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Affinity.cs#L73)
```cs:line-numbers=73
		flag2 = true;
	}
...
[`@@ -275,8 +275,6 @@ public int age`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Biography.cs#L275)
```cs:line-numbers=275
		}
	}
...
[`@@ -284,7 +282,7 @@ public string TextAge(Chara c)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Biography.cs#L284)
```cs:line-numbers=284
	object obj;
	if (age < 1000)
	{
...
[`@@ -297,6 +295,16 @@ public string TextAge(Chara c)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Biography.cs#L297)
```cs:line-numbers=297
		return (string)obj;
	}
...
[`@@ -77,12 +77,12 @@ public void Refresh()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ButtonElement.cs#L77)
```cs:line-numbers=77
		break;
	case Mode.LandFeat:
	{
...
[`@@ -96,20 +96,21 @@ public void Refresh()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ButtonElement.cs#L96)
```cs:line-numbers=96
	case Mode.FeatMini:
...
[`@@ -145,7 +146,7 @@ public void Refresh()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ButtonElement.cs#L145)
```cs:line-numbers=145
...
[`@@ -102,6 +102,8 @@ public class CINT`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/CINT.cs#L102)
```cs:line-numbers=102
...
[`@@ -1237,6 +1237,18 @@ public int c_fur`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Card.cs#L1237)
...
[`@@ -5549,6 +5561,10 @@ public void DecayNatural(int hour = 1)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Card.cs#L5549)
...
[`@@ -5560,6 +5576,15 @@ public void DecayNatural(int hour = 1)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Card.cs#L5560)
...
[`@@ -1547,7 +1547,7 @@ public int GetBurden(Card t = null, int num = -1)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Chara.cs#L1547)
...
[`@@ -6220,13 +6220,20 @@ public void ShowDialog()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Chara.cs#L6220)
...
[`@@ -8577,14 +8584,14 @@ public void ModCorruption(int a)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Chara.cs#L8577)
...
[`@@ -45,6 +45,8 @@ public class ContentConfigGame : ContentConfig`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ContentConfigGame.cs#L45)
```cs:line-numbers=45
...
[`@@ -145,6 +147,10 @@ public override void OnInstantiate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ContentConfigGame.cs#L145)
```cs:line-numbers=145
	{
...
[`@@ -108,6 +108,8 @@ public class GameConfig`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/CoreConfig.cs#L108)
```cs:line-numbers=108
...
[`@@ -151,7 +151,7 @@ public static Card MixIngredients(Card product, List<Thing> ings, MixType type,`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/CraftUtil.cs#L151)
```cs:line-numbers=151
...
[`@@ -222,6 +222,10 @@ public static Card MixIngredients(Card product, List<Thing> ings, MixType type,`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/CraftUtil.cs#L222)
```cs:line-numbers=222
	return product;
...
[`@@ -2,42 +2,42 @@`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/DOMAIN.cs#L2)
```cs:line-numbers=2
...
[`@@ -75,7 +75,7 @@ public void Talk(string text, List<DramaChoice> choices, bool center, bool unkno`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/DramaActor.cs#L75)
```cs:line-numbers=75
...
[`@@ -58,6 +58,16 @@ public void AddMaid()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/DramaOutcome.cs#L58)
```cs:line-numbers=58
	{
	}
...
[`@@ -5,9 +5,9 @@`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ELEMENT.cs#L5)
```cs:line-numbers=5
...
[`@@ -19,15 +19,17 @@ public class ELEMENT`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ELEMENT.cs#L19)
```cs:line-numbers=19
...
[`@@ -65,11 +67,12 @@ public class ELEMENT`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ELEMENT.cs#L65)
```cs:line-numbers=65
...
[`@@ -554,7 +557,14 @@ public void WriteNoteWithRef(UINote n, ElementContainer owner, Action<UINote> on`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ELEMENT.cs#L554)
```cs:line-numbers=554
	{
		n.Clear();
...
[`@@ -844,6 +854,15 @@ public virtual void SetTextValue(UIText text)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ELEMENT.cs#L844)
```cs:line-numbers=844
		text.text = text2;
	}
...
[`@@ -1,30 +1,28 @@`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ENC.cs#L1)
```cs:line-numbers=1
public class ENC
{
...
[`@@ -38,21 +36,21 @@ public class ENC`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ENC.cs#L38)
```cs:line-numbers=38
...
[`@@ -108,13 +106,17 @@ public class ENC`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ENC.cs#L108)
```cs:line-numbers=108
...
[`@@ -132,11 +134,13 @@ public class ENC`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ENC.cs#L132)
```cs:line-numbers=132
...
[`@@ -144,19 +148,15 @@ public class ENC`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ENC.cs#L144)
```cs:line-numbers=144
...
[`@@ -4,25 +4,27 @@`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FACTION.cs#L4)
```cs:line-numbers=4
...
[`@@ -36,29 +38,29 @@ public class FACTION`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FACTION.cs#L36)
```cs:line-numbers=36
...
[`@@ -80,10 +82,10 @@ public class FACTION`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FACTION.cs#L80)
```cs:line-numbers=80
...
[`@@ -104,18 +106,16 @@ public class FACTION`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FACTION.cs#L104)
```cs:line-numbers=104
...
[`@@ -379,7 +379,7 @@ public void OnAdvanceMonth()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FACTION.cs#L379)
```cs:line-numbers=379
...
[`@@ -3,15 +3,13 @@`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FEAT.cs#L3)
```cs:line-numbers=3
...
[`@@ -19,17 +17,21 @@ public class FEAT`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FEAT.cs#L19)
```cs:line-numbers=19
...
[`@@ -41,19 +43,19 @@ public class FEAT`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FEAT.cs#L41)
```cs:line-numbers=41
...
[`@@ -71,11 +73,11 @@ public class FEAT`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FEAT.cs#L71)
```cs:line-numbers=71
...
[`@@ -95,15 +97,13 @@ public class FEAT`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FEAT.cs#L95)
```cs:line-numbers=95
...
[`@@ -155,7 +155,7 @@ public class FEAT`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FEAT.cs#L155)
```cs:line-numbers=155
...
[`@@ -203,7 +203,7 @@ public class FEAT`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FEAT.cs#L203)
```cs:line-numbers=203
...
[`@@ -211,31 +211,34 @@ public class FEAT`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FEAT.cs#L211)
```cs:line-numbers=211
...
[`@@ -293,12 +296,12 @@ public string GetHint(ElementContainer owner)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FEAT.cs#L293)
```cs:line-numbers=293
...
[`@@ -306,6 +309,21 @@ public bool IsAvailable(ElementContainer owner, int a = 1)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FEAT.cs#L306)
```cs:line-numbers=306
		return true;
	}
...
[`@@ -1,9 +1,11 @@`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FOOD.cs#L1)
```cs:line-numbers=1
public class FOOD
{
...
[`@@ -12,7 +14,5 @@ public class FOOD`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FOOD.cs#L12)
```cs:line-numbers=12
...
[`@@ -81,9 +81,10 @@ public static bool IsUndeadFlesh(CardRow r)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/FoodEffect.cs#L81)
```cs:line-numbers=81
...
[`@@ -53,6 +53,9 @@ public class Config : EClass`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Game.cs#L53)
```cs:line-numbers=53
		[JsonProperty]
		public bool cheat;
...
[`@@ -75,8 +75,9 @@ public override void OnClick(ButtonGrid button)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/InvOwnerDraglet.cs#L75)
```cs:line-numbers=75
		{
			button.SetCard(null);
...
[`@@ -5,8 +5,17 @@`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/LayerDragGrid.cs#L5)
```cs:line-numbers=5
...
[`@@ -310,6 +319,36 @@ public void Redraw()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/LayerDragGrid.cs#L310)
```cs:line-numbers=310
...
[`@@ -6,19 +6,17 @@ public class MUTATION`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/MUTATION.cs#L6)
```cs:line-numbers=6
...
[`@@ -26,6 +24,8 @@ public class MUTATION`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/MUTATION.cs#L26)
```cs:line-numbers=26
...
[`@@ -78,8 +78,8 @@ public class MUTATION`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/MUTATION.cs#L78)
```cs:line-numbers=78
...
[`@@ -49,7 +49,7 @@ public class POLICY`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/POLICY.cs#L49)
```cs:line-numbers=49
...
[`@@ -65,7 +65,7 @@ public class POLICY`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/POLICY.cs#L65)
```cs:line-numbers=65
...
[`@@ -75,7 +75,7 @@ public class POLICY`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/POLICY.cs#L75)
```cs:line-numbers=75
...
[`@@ -105,8 +105,8 @@ public class POLICY`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/POLICY.cs#L105)
```cs:line-numbers=105
	{
...
[`@@ -419,6 +419,18 @@ public bool toggleHotbarHighlightActivated`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Player.cs#L419)
```cs:line-numbers=419
			}
		}
...
[`@@ -249,6 +249,11 @@ public override Thing Craft(BlessedState blessed, bool sound = false, List<Thing`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/RecipeCard.cs#L249)
```cs:line-numbers=249
			if (!flag)
			{
				MakeDish(thing);
...
[`@@ -4,6 +4,12 @@`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Religion.cs#L4)
```cs:line-numbers=4
...
[`@@ -160,6 +166,7 @@ public string GetGodTalk(string suffix)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Religion.cs#L160)
```cs:line-numbers=160
...
[`@@ -194,7 +201,7 @@ public int GetOfferingValue(Thing t, int num = -1)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Religion.cs#L194)
```cs:line-numbers=194
		{
			num2 /= 10;
		}
...
[`@@ -361,7 +368,7 @@ public virtual void OnBecomeBranchFaith()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Religion.cs#L361)
```cs:line-numbers=361
	{
	}
...
[`@@ -373,9 +380,12 @@ public void JoinFaith(Chara c)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Religion.cs#L373)
```cs:line-numbers=373
	}
	if (c.faith != this)
	{
...
[`@@ -401,7 +411,7 @@ public void JoinFaith(Chara c)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Religion.cs#L401)
```cs:line-numbers=401
		}
	}
...
[`@@ -411,7 +421,7 @@ public void LeaveFaith(Chara c, Religion newFaith)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Religion.cs#L411)
```cs:line-numbers=411
	if (c.IsPC)
	{
		Msg.Say("worship2");
...
[`@@ -314,7 +314,7 @@ public void Init(Mode newMode)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Scene.cs#L314)
```cs:line-numbers=314
		{
...
[`@@ -673,7 +673,10 @@ public void Restore(Map map, Map orgMap, bool addToZone, PartialMap partial = nu`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/SerializedCards.cs#L673)
```cs:line-numbers=673
...
[`@@ -836,6 +836,10 @@ public List<Element> ListValidTraits(bool isCraft, bool limit)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Thing.cs#L836)
```cs:line-numbers=836
...
[`@@ -181,6 +181,13 @@ public static Thing CreatePerfume(int ele, int num = 1)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/ThingGen.cs#L181)
```cs:line-numbers=181
		return thing;
	}
...
[`@@ -1482,6 +1482,11 @@ public void OnBarter()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Trait.cs#L1482)
...
[`@@ -1524,9 +1529,9 @@ public void OnBarter()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Trait.cs#L1524)
...
[`@@ -1733,18 +1738,18 @@ public void OnBarter()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Trait.cs#L1733)
...
[`@@ -25,7 +25,7 @@ public override void OnCreate(int lv)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/TraitAltar.cs#L25)
```cs:line-numbers=25
...
[`@@ -277,8 +277,8 @@ public virtual Thing Craft(AI_UseCrafter ai)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/TraitCrafter.cs#L277)
```cs:line-numbers=277
		break;
...
[`@@ -344,13 +344,13 @@ public virtual Thing Craft(AI_UseCrafter ai)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/TraitCrafter.cs#L344)
```cs:line-numbers=344
...
[`@@ -362,9 +362,14 @@ public virtual Thing Craft(AI_UseCrafter ai)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/TraitCrafter.cs#L362)
```cs:line-numbers=362
...
[`@@ -408,10 +413,6 @@ public virtual Thing Craft(AI_UseCrafter ai)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/TraitCrafter.cs#L408)
```cs:line-numbers=408
...
[`@@ -12,7 +12,17 @@ public class TraitDoor : Trait`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/TraitDoor.cs#L12)
```cs:line-numbers=12
...
[`@@ -88,18 +98,21 @@ public virtual bool IsOpen()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/TraitDoor.cs#L88)
```cs:line-numbers=88
	{
		int dir = owner.dir;
...
[`@@ -107,21 +120,26 @@ public bool IsValid()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/TraitDoor.cs#L107)
```cs:line-numbers=107
	{
		return false;
	}
...
[`@@ -16,7 +16,7 @@ public override bool OnUse(Chara c)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/TraitGiftJure.cs#L16)
```cs:line-numbers=16
	}
...
[`@@ -28,17 +28,20 @@ public override bool OnUse(Chara c)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/TraitGiftJure.cs#L28)
```cs:line-numbers=28
		Add("cake_festival", 3);
		Add("bushdenoel", 3);
		Add("mancookie", 3);
...
[`@@ -51,14 +51,14 @@ public override void _OnUse(Chara c)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/TraitGodStatue.cs#L51)
```cs:line-numbers=51
	{
	case "harvest":
	{
...
[`@@ -76,7 +76,7 @@ public override void _OnUse(Chara c)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/TraitGodStatue.cs#L76)
```cs:line-numbers=76
	case "element":
	{
...
[`@@ -6,7 +6,7 @@ public class TraitMusicBox : TraitJukeBox`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/TraitMusicBox.cs#L6)
```cs:line-numbers=6
...
[`@@ -23,7 +23,7 @@ public override void OnEndAI(AI_UseCrafter ai)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/TraitRollingFortune.cs#L23)
```cs:line-numbers=23
		}
...
[`@@ -27,6 +27,8 @@ public class UIDragGridInfo : EMono`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/UIDragGridInfo.cs#L27)
```cs:line-numbers=27
...
[`@@ -100,6 +102,12 @@ public void Init(Card _owner)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/UIDragGridInfo.cs#L100)
```cs:line-numbers=100
		}
	};
	list.List();
...
[`@@ -14,9 +14,9 @@ public class UIDragGridIngredients : EMono`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/UIDragGridIngredients.cs#L14)
```cs:line-numbers=14
public void Update()
{
...
[`@@ -28,11 +28,13 @@ public void Update()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/UIDragGridIngredients.cs#L28)
```cs:line-numbers=28
...
[`@@ -66,6 +68,7 @@ public void Refresh()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/UIDragGridIngredients.cs#L66)
```cs:line-numbers=66
			int currentIndex = layer.currentIndex;
...
[`@@ -158,6 +158,8 @@ public bool UseBG`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/UIInventory.cs#L158)
```cs:line-numbers=158
...
[`@@ -462,7 +464,7 @@ public void RefreshMenu()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/UIInventory.cs#L462)
```cs:line-numbers=462
...
[`@@ -472,11 +474,12 @@ public void RefreshMenu()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/UIInventory.cs#L472)
```cs:line-numbers=472
					{
...
[`@@ -486,6 +489,7 @@ public void RefreshMenu()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/UIInventory.cs#L486)
```cs:line-numbers=486
				{
...
[`@@ -995,7 +999,7 @@ public Transform ShowAdvDistribution(UIContextMenu dis, Window.SaveData data)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/UIInventory.cs#L995)
```cs:line-numbers=995
...
[`@@ -1033,7 +1037,7 @@ public void Sort(bool redraw = true)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/UIInventory.cs#L1033)
...
[`@@ -21,6 +21,7 @@ public void Refresh()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/UIPlaceHelper.cs#L21)
```cs:line-numbers=21
...
[`@@ -136,6 +136,8 @@ public class WindowChara : WindowController`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/WindowChara.cs#L136)
```cs:line-numbers=136
...
[`@@ -204,6 +206,7 @@ public override void OnSwitchContent(Window window)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/WindowChara.cs#L204)
```cs:line-numbers=204
			}
...
[`@@ -235,6 +238,12 @@ public void ToggleFeatMode()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/WindowChara.cs#L235)
```cs:line-numbers=235
	{
		featMode = !featMode;
...
[`@@ -763,7 +772,11 @@ void List(string lang, string idSubCat)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/WindowChara.cs#L763)
```cs:line-numbers=763
		{
...
[`@@ -787,7 +800,7 @@ void List(string lang, string idSubCat)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/WindowChara.cs#L787)
```cs:line-numbers=787
			},
			onList = delegate
			{
...
[`@@ -54,6 +54,9 @@ public class PortalReturnData`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Zone.cs#L54)
```cs:line-numbers=54
	[JsonProperty]
...
[`@@ -3428,4 +3431,18 @@ public void ApplyBackerPet(bool draw)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/11bd8a86bcfa904245733c4f98b3aca51efc70e7/Elin/Zone.cs#L3428)

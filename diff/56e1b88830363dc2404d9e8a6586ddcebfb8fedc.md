...
[`@@ -44,7 +44,7 @@ public override bool Perform()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/ActRide.cs#L44)
```cs:line-numbers=44
		return false;
	}
...
[`@@ -86,8 +86,11 @@ public static void Ride(Chara host, Chara t, bool parasite = false)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/ActRide.cs#L86)
```cs:line-numbers=86
	}
	t.host = host;
	t._CreateRenderer();
...
[`@@ -95,7 +98,7 @@ public static void Ride(Chara host, Chara t, bool parasite = false)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/ActRide.cs#L95)
```cs:line-numbers=95
		host.Refresh();
	}
...
[`@@ -112,10 +115,15 @@ public static void Unride(Chara host, bool parasite = false)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/ActRide.cs#L112)
```cs:line-numbers=112
		}
		chara.host = null;
...
[`@@ -22,6 +22,8 @@ public enum MoveType`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Card.cs#L22)
```cs:line-numbers=22
		Force
	}
...
[`@@ -64,6 +66,8 @@ public enum MoveType`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Card.cs#L64)
```cs:line-numbers=64
...
[`@@ -1828,9 +1832,9 @@ public int ChildrenWeight`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Card.cs#L1828)
...
[`@@ -247,7 +247,7 @@ public virtual void RefreshSprite()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/CardActor.cs#L247)
```cs:line-numbers=247
...
[`@@ -2875,10 +2875,7 @@ public void MoveZone(Zone z, ZoneTransition transition)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Chara.cs#L2875)
...
[`@@ -3292,9 +3289,16 @@ public void TickConditions()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Chara.cs#L3292)
...
[`@@ -4013,6 +4017,18 @@ public Card SplitHeld(int a)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Chara.cs#L4013)
...
[`@@ -4055,6 +4071,10 @@ public void DropThing(Thing t, int num = -1)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Chara.cs#L4055)
...
[`@@ -4687,10 +4707,7 @@ public override void Die(Element e = null, Card origin = null, AttackSource atta`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Chara.cs#L4687)
...
[`@@ -5540,7 +5557,7 @@ public void CallHelp(Chara tg, bool fanatic = false)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Chara.cs#L5540)
...
[`@@ -8332,13 +8349,16 @@ public void Cure(CureType type, int p = 100, BlessedState state = BlessedState.N`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Chara.cs#L8332)
...
[`@@ -27,6 +27,10 @@ public override void RefreshSprite()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/CharaActor.cs#L27)
```cs:line-numbers=27
...
[`@@ -124,6 +124,10 @@ public override void OnRender(RenderParam p)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/CharaActorPCC.cs#L124)
```cs:line-numbers=124
				p.v.x = p.x;
				p.v.y = p.y;
				p.v.z = p.z;
...
[`@@ -148,24 +152,31 @@ public override void OnRender(RenderParam p)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/CharaActorPCC.cs#L148)
```cs:line-numbers=148
			break;
		}
		case 0:
...
[`@@ -12,15 +12,12 @@ public override void OnRemoved()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/ConBoost.cs#L12)
```cs:line-numbers=12
...
[`@@ -25,6 +25,12 @@ public class ConSleep : BadCondition`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/ConSleep.cs#L25)
```cs:line-numbers=25
	[JsonProperty]
	public bool slept;
...
[`@@ -64,6 +70,19 @@ public override void Tick()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/ConSleep.cs#L64)
```cs:line-numbers=64
	}
...
[`@@ -213,71 +232,88 @@ public override void OnRemoved()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/ConSleep.cs#L213)
```cs:line-numbers=213
	if (!owner.IsPC)
	{
...
[`@@ -274,19 +274,7 @@ public override bool TrySetAct(ActPlan p)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/HotItemHeld.cs#L274)
```cs:line-numbers=274
...
[`@@ -163,7 +163,7 @@ public void SetBaseRoom(Room r)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Lot.cs#L163)
```cs:line-numbers=163
	}
...
[`@@ -30,6 +30,8 @@ public class TaskBuild : TaskBaseBuild`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/TaskBuild.cs#L30)
```cs:line-numbers=30
...
[`@@ -69,8 +71,25 @@ public override bool CanManualCancel()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/TaskBuild.cs#L69)
```cs:line-numbers=69
		return true;
	}
...
[`@@ -133,6 +152,10 @@ public override HitResult GetHitResult()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/TaskBuild.cs#L133)
```cs:line-numbers=133
		{
...
[`@@ -248,6 +271,14 @@ public override void OnProgressComplete()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/TaskBuild.cs#L248)
```cs:line-numbers=248
		{
			return;
		}
...
[`@@ -1408,33 +1408,56 @@ public override void SetRenderParam(RenderParam p)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Thing.cs#L1408)
...
[`@@ -1469,10 +1492,10 @@ public override void SetRenderParam(RenderParam p)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Thing.cs#L1469)
...
[`@@ -10,7 +10,8 @@ public enum TileMode`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Trait.cs#L10)
```cs:line-numbers=10
		Default,
		Door,
		Illumination,
...
[`@@ -1,7 +1,10 @@`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/TraitDoorBell.cs#L1)
```cs:line-numbers=1
...
[`@@ -14,7 +14,8 @@ public override void TrySetHeldAct(ActPlan p)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/TraitEcoMark.cs#L14)
```cs:line-numbers=14
				SE.Play("click_paper");
				owner.ModNum(-1);
...
[`@@ -16,6 +16,11 @@ public override void OnBeforeDeactivate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/56e1b88830363dc2404d9e8a6586ddcebfb8fedc/Elin/Zone_Tent.cs#L16)
```cs:line-numbers=16

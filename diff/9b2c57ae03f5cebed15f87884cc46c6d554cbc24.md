...
[`@@ -372,9 +372,9 @@ public override void OnClick(Chara c, ItemGeneral i)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/BaseListPeople.cs#L372)
```cs:line-numbers=372
						SE.Click();
					}
				});
...
[`@@ -86,24 +86,28 @@ public override void Tick()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/ConSleep.cs#L86)
```cs:line-numbers=86
		}
		base.value = 1;
		slept = true;
...
[`@@ -147,7 +151,7 @@ public override void Tick()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/ConSleep.cs#L147)
```cs:line-numbers=147
...
[`@@ -930,38 +930,16 @@ public void UpdateInput()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/CoreDebug.cs#L930)
```cs:line-numbers=930
	}
...
[`@@ -1032,7 +1010,7 @@ public void UpdateInput()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/CoreDebug.cs#L1032)
...
[`@@ -1172,8 +1150,8 @@ public void UpdateInput()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/CoreDebug.cs#L1172)
...
[`@@ -1249,64 +1227,64 @@ public void UpdateInput()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/CoreDebug.cs#L1249)
...
[`@@ -224,7 +224,11 @@ public void Generate(Type _type, Chara model = null)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/DNA.cs#L224)
```cs:line-numbers=224
	Rand.SetSeed(seed);
	if (model == null)
	{
...
[`@@ -123,9 +123,6 @@ public class Faction : EClass`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/FACTION.cs#L123)
```cs:line-numbers=123
	[JsonProperty]
...
[`@@ -190,6 +187,16 @@ public int CountTax()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/FACTION.cs#L190)
```cs:line-numbers=190
...
[`@@ -335,7 +342,7 @@ public void RemoveReserve(Chara c)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/FACTION.cs#L335)
```cs:line-numbers=335
...
[`@@ -392,7 +399,7 @@ public void TryPayBill(Thing bill)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/FACTION.cs#L392)
```cs:line-numbers=392
...
[`@@ -410,7 +417,7 @@ public void AddGlobalPolicy(int id)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/FACTION.cs#L410)
```cs:line-numbers=410
...
[`@@ -422,7 +429,7 @@ public bool IsGlobalPolicyActive(int id)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/FACTION.cs#L422)
```cs:line-numbers=422
...
[`@@ -431,7 +438,7 @@ public void SetGlobalPolicyActive(int id, bool active)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/FACTION.cs#L431)
```cs:line-numbers=431
...
[`@@ -445,7 +452,7 @@ public int GetResidentTax()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/FACTION.cs#L445)
```cs:line-numbers=445
...
[`@@ -495,7 +502,7 @@ public int EvadeTax(int v, bool evasion)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/FACTION.cs#L495)
```cs:line-numbers=495
		return v;
	}
	int num = 0;
...
[`@@ -513,7 +520,7 @@ public void SetTaxTooltip(UINote n)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/FACTION.cs#L513)
```cs:line-numbers=513
...
[`@@ -946,7 +946,7 @@ public int GetResidentTax()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/FactionBranch.cs#L946)
```cs:line-numbers=946
		{
...
[`@@ -168,6 +168,10 @@ public static void PrepareSteamCloud(string id, string path = "")`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/GameIO.cs#L168)
```cs:line-numbers=168
		{
			File.Delete(text);
		}
...
[`@@ -403,7 +403,7 @@ public bool HasRoomOrArea(BaseArea a)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Point.cs#L403)
```cs:line-numbers=403
		return true;
	}
...
[`@@ -616,7 +616,6 @@ public Point GetNearestPoint(bool allowBlock = false, bool allowChara = true, bo`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Point.cs#L616)
```cs:line-numbers=616
				return p;
			}
		}
...
[`@@ -625,6 +624,7 @@ public Point GetNearestPoint(bool allowBlock = false, bool allowChara = true, bo`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Point.cs#L625)
```cs:line-numbers=625
				return p;
			}
		}
...
[`@@ -633,7 +633,6 @@ public Point GetNearestPoint(bool allowBlock = false, bool allowChara = true, bo`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Point.cs#L633)
```cs:line-numbers=633
				return p;
			}
		}
...
[`@@ -642,6 +641,7 @@ public Point GetNearestPoint(bool allowBlock = false, bool allowChara = true, bo`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Point.cs#L642)
```cs:line-numbers=642
				return p;
			}
		}
...
[`@@ -660,7 +660,7 @@ bool IsValid(int dx, int dz)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Point.cs#L660)
```cs:line-numbers=660
		}
	}
...
[`@@ -674,7 +674,7 @@ public bool ForeachNearestPoint(Func<Point, bool> endFunc, bool allowBlock = fal`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Point.cs#L674)
```cs:line-numbers=674
	{
		return true;
	}
...
[`@@ -684,7 +684,6 @@ public bool ForeachNearestPoint(Func<Point, bool> endFunc, bool allowBlock = fal`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Point.cs#L684)
```cs:line-numbers=684
				return true;
			}
		}
...
[`@@ -693,6 +692,7 @@ public bool ForeachNearestPoint(Func<Point, bool> endFunc, bool allowBlock = fal`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Point.cs#L693)
```cs:line-numbers=693
				return true;
			}
		}
...
[`@@ -701,7 +701,6 @@ public bool ForeachNearestPoint(Func<Point, bool> endFunc, bool allowBlock = fal`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Point.cs#L701)
```cs:line-numbers=701
				return true;
			}
		}
...
[`@@ -710,6 +709,7 @@ public bool ForeachNearestPoint(Func<Point, bool> endFunc, bool allowBlock = fal`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Point.cs#L710)
```cs:line-numbers=710
				return true;
			}
		}
...
[`@@ -47,5 +47,6 @@ public enum ShopType`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/ShopType.cs#L47)
```cs:line-numbers=47
	Copy,
	Plat,
	LoytelMart,
...
[`@@ -108,23 +108,7 @@ private void CreateUserContent2(UgcQuery query)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Steam.cs#L108)
```cs:line-numbers=108
		}
	}
...
[`@@ -137,6 +121,7 @@ private void CreateUserContent2(UgcQuery query)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Steam.cs#L137)
```cs:line-numbers=137
		if (result.hasError)
		{
...
[`@@ -150,23 +135,16 @@ private void CreateUserContent2(UgcQuery query)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Steam.cs#L150)
```cs:line-numbers=150
...
[`@@ -176,4 +154,39 @@ public void UpdateUserContent(PublishedFileId_t fileId)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Steam.cs#L176)
```cs:line-numbers=176
			}
		});
	}
...
[`@@ -1676,6 +1676,7 @@ public void OnBarter()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Trait.cs#L1676)
...
[`@@ -1947,9 +1948,9 @@ public Thing CreateStock()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Trait.cs#L1947)
...
[`@@ -1971,45 +1972,45 @@ public Thing CreateStock()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Trait.cs#L1971)
...
[`@@ -2062,11 +2063,17 @@ public Thing CreateStock()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Trait.cs#L2062)
...
[`@@ -1433,6 +1433,7 @@ public void AddGlobalCharasOnActivate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Zone.cs#L1433)
...
[`@@ -1464,13 +1465,13 @@ public void AddGlobalCharasOnActivate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/9b2c57ae03f5cebed15f87884cc46c6d554cbc24/Elin/Zone.cs#L1464)

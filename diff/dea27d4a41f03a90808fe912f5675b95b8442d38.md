...
[`@@ -246,7 +246,7 @@ public virtual bool Perform()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/ACT.cs#L246)
```cs:line-numbers=246
	int num = id;
...
[`@@ -267,7 +267,7 @@ public virtual bool Perform()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/ACT.cs#L267)
```cs:line-numbers=267
			TC = CC;
			TP.Set(CC.pos);
		}
...
[`@@ -450,8 +450,7 @@ public virtual void OnMarkMapHighlights()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/ACT.cs#L450)
```cs:line-numbers=450
	{
...
[`@@ -47,6 +47,17 @@ public override IEnumerable<Status> Run()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/AI_Idle.cs#L47)
```cs:line-numbers=47
			}
...
[`@@ -505,19 +505,16 @@ public void ThrowReward(Chara c, bool punish)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/AI_PlayMusic.cs#L505)
```cs:line-numbers=505
...
[`@@ -1,3 +1,5 @@`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/ActBolt.cs#L1)
```cs:line-numbers=1
...
[`@@ -7,4 +9,23 @@ public class ActBolt : Spell`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/ActBolt.cs#L7)
```cs:line-numbers=7
...
[`@@ -244,6 +244,10 @@ public static bool DamageEle(Card CC, EffectId id, int power, Element e, List<Po`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/ActEffect.cs#L244)
```cs:line-numbers=244
				{
...
[`@@ -297,6 +301,11 @@ public static bool DamageEle(Card CC, EffectId id, int power, Element e, List<Po`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/ActEffect.cs#L297)
```cs:line-numbers=297
					break;
				}
			}
...
[`@@ -384,10 +393,6 @@ public static bool DamageEle(Card CC, EffectId id, int power, Element e, List<Po`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/ActEffect.cs#L384)
```cs:line-numbers=384
		}
		Debug.Log(angle);
	}
...
[`@@ -15,8 +15,7 @@ public override void OnMarkMapHighlights()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/ActRush.cs#L15)
```cs:line-numbers=15
	{
...
[`@@ -96,7 +96,11 @@ public static void Toggle()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/BuildMenu.cs#L96)
```cs:line-numbers=96
...
[`@@ -5728,7 +5728,7 @@ public bool IsFriendOrAbove(Chara c)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/Chara.cs#L5728)
...
[`@@ -1868,7 +1868,7 @@ public static string SetElement(string alias, int value, int potential = 100)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/CoreDebug.cs#L1868)
...
[`@@ -1876,7 +1876,7 @@ public static string Spawn(string id, int num = 1, string aliasMat = "")`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/CoreDebug.cs#L1876)
...
[`@@ -1887,6 +1887,10 @@ public static string Spawn(string id, int num = 1, string aliasMat = "")`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/CoreDebug.cs#L1887)
...
[`@@ -416,7 +416,7 @@ public virtual int GetSourceValue(int v, int lv, SourceValueType type)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/ELEMENT.cs#L416)
```cs:line-numbers=416
		{
...
[`@@ -14,7 +14,8 @@ public class GameIO : EClass`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/GameIO.cs#L14)
```cs:line-numbers=14
...
[`@@ -110,6 +110,10 @@ public static void Show(string id, Vector3 pos)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/HotItemContext.cs#L110)
```cs:line-numbers=110
			{
...
[`@@ -108,6 +108,13 @@ public override void Init(string path, string defaultPackage = "_Elona")`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/ModManager.cs#L108)
```cs:line-numbers=108
...
[`@@ -903,7 +903,7 @@ public void OnLeaveZone()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/Player.cs#L903)
```cs:line-numbers=903
...
[`@@ -2151,9 +2151,9 @@ public bool TryAbortAutoCombat()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/Player.cs#L2151)
...
[`@@ -1374,4 +1374,10 @@ public Point ToRegionPos()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/Point.cs#L1374)
...
[`@@ -23,17 +23,29 @@ public class Row : BaseRow`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/SourceElement.cs#L23)
```cs:line-numbers=23
...
[`@@ -59,16 +71,6 @@ public class Row : BaseRow`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/SourceElement.cs#L59)
```cs:line-numbers=59
...
[`@@ -79,8 +81,6 @@ public class Row : BaseRow`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/SourceElement.cs#L79)
```cs:line-numbers=79
...
[`@@ -273,35 +273,35 @@ public override Row CreateRow()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/SourceElement.cs#L273)
```cs:line-numbers=273
...
[`@@ -498,7 +498,7 @@ public void HarvestThing()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/TaskHarvest.cs#L498)
```cs:line-numbers=498
	}
...
[`@@ -1846,15 +1846,19 @@ public void DoAct(Act act)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/Thing.cs#L1846)
...
[`@@ -1982,45 +1982,45 @@ public Thing CreateStock()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/Trait.cs#L1982)
...
[`@@ -2047,6 +2047,10 @@ public Thing CreateStock()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/Trait.cs#L2047)
...
[`@@ -12,7 +12,7 @@ public override void OnActivateTrap(Chara c)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/TraitHitchingPost.cs#L12)
```cs:line-numbers=12
	{
...
[`@@ -7,4 +7,6 @@ public class TraitLoytel : TraitUniqueMerchant`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/TraitLoytel.cs#L7)
```cs:line-numbers=7
...
[`@@ -17,4 +17,16 @@ public override ShopType ShopType`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/TraitMerchantBlack.cs#L17)
```cs:line-numbers=17
	}
...
[`@@ -46,6 +46,8 @@ public class Extra`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/WidgetStatsBar.cs#L46)
```cs:line-numbers=46
...
[`@@ -53,6 +55,8 @@ public class Extra`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/WidgetStatsBar.cs#L53)
```cs:line-numbers=53
		public bool fame;
...
[`@@ -87,6 +91,10 @@ public class Extra`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/WidgetStatsBar.cs#L87)
```cs:line-numbers=87
...
[`@@ -106,6 +114,10 @@ public override void OnActivate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/WidgetStatsBar.cs#L106)
```cs:line-numbers=106
{
	Instance = this;
...
[`@@ -130,6 +142,10 @@ public void Build()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/WidgetStatsBar.cs#L130)
```cs:line-numbers=130
	{
...
[`@@ -170,6 +186,26 @@ public void Build()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/WidgetStatsBar.cs#L170)
```cs:line-numbers=170
	{
...
[`@@ -287,6 +323,11 @@ public override void OnSetContextMenu(UIContextMenu m)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/WidgetStatsBar.cs#L287)
```cs:line-numbers=287
		extra.maxAlly = a;
		Build();
	});
...
[`@@ -340,6 +381,11 @@ public override void OnSetContextMenu(UIContextMenu m)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/WidgetStatsBar.cs#L340)
```cs:line-numbers=340
		extra.hearthLv = a;
		Build();
	});
...
[`@@ -3,4 +3,6 @@ public class Zone_EmbassyPalmia : Zone_Civilized`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/dea27d4a41f03a90808fe912f5675b95b8442d38/Elin/Zone_EmbassyPalmia.cs#L3)
```cs:line-numbers=3

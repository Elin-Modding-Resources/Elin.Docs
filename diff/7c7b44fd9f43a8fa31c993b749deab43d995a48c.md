...
[`@@ -989,6 +989,18 @@ public bool c_isPrayed`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/Card.cs#L989)
```cs:line-numbers=989
		}
	}
...
[`@@ -4711,13 +4723,13 @@ public void SpawnLoot(Card origin)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/Card.cs#L4711)
...
[`@@ -6048,7 +6060,7 @@ public void Decay(int a = 10)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/Card.cs#L6048)
...
[`@@ -7249,13 +7261,13 @@ public bool CanBeSheared()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/Card.cs#L7249)
...
[`@@ -1550,15 +1550,31 @@ public void RefreshSpeed()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/Chara.cs#L1550)
...
[`@@ -1581,34 +1605,62 @@ public void RefreshSpeed()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/Chara.cs#L1581)
...
[`@@ -503,7 +511,7 @@ public void _WriteNote(UINote n, Chara c, Act act)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/Element.2.cs#L503)
```cs:line-numbers=503
			}
			else
			{
...
[`@@ -816,7 +837,7 @@ public static int GetResistDamage(int dmg, int v)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/Element.2.cs#L816)
```cs:line-numbers=816
	}
...
[`@@ -289,86 +297,86 @@ public List<string> Apply(int a, ElementContainer owner, bool hint = false)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/Feat.2.cs#L289)
```cs:line-numbers=289
	{
		if (i == 1419)
		{
...
[`@@ -420,8 +428,8 @@ public List<string> Apply(int a, ElementContainer owner, bool hint = false)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/Feat.2.cs#L420)
```cs:line-numbers=420
			}
			goto IL_12F3;
		case 1555:
...
[`@@ -484,59 +492,59 @@ public List<string> Apply(int a, ElementContainer owner, bool hint = false)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/Feat.2.cs#L484)
```cs:line-numbers=484
			case 1641:
				goto IL_12F3;
			case 1620:
...
[`@@ -617,14 +625,14 @@ public List<string> Apply(int a, ElementContainer owner, bool hint = false)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/Feat.2.cs#L617)
```cs:line-numbers=617
		{
			int num = 0;
...
[`@@ -669,7 +677,7 @@ public List<string> Apply(int a, ElementContainer owner, bool hint = false)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/Feat.2.cs#L669)
```cs:line-numbers=669
	{
...
[`@@ -38,7 +38,7 @@ public override bool AllowStockIngredients`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/InvOwnerCraft.cs#L38)
```cs:line-numbers=38
	{
		get
		{
...
[`@@ -30,7 +30,7 @@ public override bool AllowStockIngredients`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/InvOwnerRefuel.cs#L30)
```cs:line-numbers=30
	{
		get
		{
...
[`@@ -73,6 +73,7 @@ public LayerDragGrid SetInv(InvOwnerDraglet owner, bool refuelFromLayerDragGrid`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/LayerDragGrid.cs#L73)
```cs:line-numbers=73
...
[`@@ -113,7 +114,7 @@ public LayerDragGrid SetInv(InvOwnerDraglet owner, bool refuelFromLayerDragGrid`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/LayerDragGrid.cs#L113)
```cs:line-numbers=113
	{
...
[`@@ -125,9 +126,9 @@ public LayerDragGrid SetInv(InvOwnerDraglet owner, bool refuelFromLayerDragGrid`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/LayerDragGrid.cs#L125)
```cs:line-numbers=125
...
[`@@ -152,6 +153,13 @@ public LayerDragGrid SetInv(InvOwnerDraglet owner, bool refuelFromLayerDragGrid`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/LayerDragGrid.cs#L152)
```cs:line-numbers=152
			owner.OnAfterRefuel();
		}
	});
...
[`@@ -187,6 +195,8 @@ public void RefreshCost()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/LayerDragGrid.cs#L187)
```cs:line-numbers=187
{
...
[`@@ -507,6 +517,8 @@ public static LayerDragGrid CreateReconstruction(Chara cc, BlessedState state =`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/LayerDragGrid.cs#L507)
```cs:line-numbers=507
...
[`@@ -5,6 +5,7 @@ public class LayerMiniGame : ELayer`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/LayerMiniGame.cs#L5)
```cs:line-numbers=5
{
...
[`@@ -58,6 +59,10 @@ public void Run()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/LayerMiniGame.cs#L58)
```cs:line-numbers=58
...
[`@@ -77,6 +82,8 @@ public override void OnKill()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/LayerMiniGame.cs#L77)
```cs:line-numbers=77
		}
	}
...
[`@@ -56,6 +56,10 @@ public virtual void OnDeactivate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/MiniGame.cs#L56)
```cs:line-numbers=56
	{
	}
...
[`@@ -42,6 +42,11 @@ public override void OnActivate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/MiniGame_Basket.cs#L42)
```cs:line-numbers=42
...
[`@@ -49,6 +49,11 @@ public override void OnActivate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/MiniGame_Blackjack.cs#L49)
```cs:line-numbers=49
...
[`@@ -424,7 +424,7 @@ public void RefreshEmptyAlly()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/Player.cs#L424)
```cs:line-numbers=424
...
[`@@ -35,8 +35,7 @@ public void Refresh()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/UIDragGridIngredients.cs#L35)
```cs:line-numbers=35
{
...
[`@@ -42,12 +42,18 @@ public override void OnActivate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/WidgetSideScreen.cs#L42)
```cs:line-numbers=42
...
[`@@ -105,6 +111,31 @@ public override void OnChangeResolution()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/WidgetSideScreen.cs#L105)
```cs:line-numbers=105
...
[`@@ -115,8 +146,13 @@ private void OnEnable()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/WidgetSideScreen.cs#L115)
```cs:line-numbers=115
...
[`@@ -132,5 +168,7 @@ public class Extra`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/7c7b44fd9f43a8fa31c993b749deab43d995a48c/Elin/WidgetSideScreen.cs#L132)
```cs:line-numbers=132
		public int bgColor;

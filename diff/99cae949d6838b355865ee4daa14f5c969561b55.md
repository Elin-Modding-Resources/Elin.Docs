...
[`@@ -873,19 +873,24 @@ public override void _OnUpdateInput()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/AM_Adv.cs#L873)
```cs:line-numbers=873
		}
		break;
...
[`@@ -677,40 +677,37 @@ public void _Update(PointTarget target)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/ActPlan.cs#L677)
```cs:line-numbers=677
					Thing t = _c.Thing;
...
[`@@ -1047,7 +1047,7 @@ public void DoFunc(CoreConfig.GameFuncBuild func)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/ActionMode.cs#L1047)
...
[`@@ -1153,7 +1153,7 @@ public void DoFunc(CoreConfig.GameFunc func)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/ActionMode.cs#L1153)
...
[`@@ -96,13 +96,13 @@ public static void Toggle()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/BuildMenu.cs#L96)
```cs:line-numbers=96
...
[`@@ -3614,11 +3614,7 @@ public void DamageHP(int dmg, int ele, int eleP = 100, AttackSource attackSource`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Card.cs#L3614)
...
[`@@ -3763,7 +3759,7 @@ public void DamageHP(int dmg, int ele, int eleP = 100, AttackSource attackSource`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Card.cs#L3763)
...
[`@@ -3775,8 +3771,8 @@ public void DamageHP(int dmg, int ele, int eleP = 100, AttackSource attackSource`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Card.cs#L3775)
...
[`@@ -4108,6 +4108,10 @@ public void RestockEquip(bool onCreate)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Chara.cs#L4108)
...
[`@@ -4441,7 +4445,10 @@ public void Revive(Point p = null, bool msg = false)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Chara.cs#L4441)
...
[`@@ -91,6 +91,8 @@ public bool IsGameStarted`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Core.cs#L91)
```cs:line-numbers=91
...
[`@@ -183,7 +185,6 @@ protected override void Awake()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Core.cs#L183)
```cs:line-numbers=183
...
[`@@ -930,16 +930,38 @@ public void UpdateInput()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/CoreDebug.cs#L930)
```cs:line-numbers=930
	}
...
[`@@ -1010,7 +1032,7 @@ public void UpdateInput()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/CoreDebug.cs#L1010)
...
[`@@ -1150,8 +1172,8 @@ public void UpdateInput()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/CoreDebug.cs#L1150)
...
[`@@ -1227,64 +1249,64 @@ public void UpdateInput()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/CoreDebug.cs#L1227)
...
[`@@ -201,7 +201,7 @@ public bool CanRemove()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/DNA.cs#L201)
```cs:line-numbers=201
...
[`@@ -283,6 +283,13 @@ public void OnAfterSimulate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/FactionBranch.cs#L283)
```cs:line-numbers=283
		{
			GetDailyIncome();
		}
...
[`@@ -295,6 +295,17 @@ public void OnUpdate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Game.cs#L295)
```cs:line-numbers=295
		updater.FixedUpdate();
	}
...
[`@@ -426,6 +437,16 @@ public void OnLoad()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Game.cs#L426)
```cs:line-numbers=426
			}
		}
	});
...
[`@@ -488,9 +509,9 @@ public void OnLoad()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Game.cs#L488)
```cs:line-numbers=488
	});
...
[`@@ -140,6 +140,12 @@ public static void MakeBackup(GameIndex index, string suffix = "")`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/GameIO.cs#L140)
```cs:line-numbers=140
...
[`@@ -249,11 +249,14 @@ public void RefreshInfo(GameIndex i)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/LayerLoadGame.cs#L249)
```cs:line-numbers=249
		{
...
[`@@ -265,7 +268,10 @@ public void RefreshInfo(GameIndex i)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/LayerLoadGame.cs#L265)
```cs:line-numbers=265
				i.madeBackup = true;
...
[`@@ -35,7 +35,7 @@ public override void OnInit()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/LayerMod.cs#L35)
```cs:line-numbers=35
		{
...
[`@@ -142,6 +142,7 @@ public void Activate(SkinDecoActor actor)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/LayerSkinDeco.cs#L142)
```cs:line-numbers=142
...
[`@@ -407,7 +407,7 @@ public bool IsInSpot<T>() where T : Trait`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Point.cs#L407)
```cs:line-numbers=407
{
...
[`@@ -284,6 +284,7 @@ public void Init(Mode newMode)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Scene.cs#L284)
```cs:line-numbers=284
...
[`@@ -33,7 +33,7 @@ public override void TrySetAct(ActPlan p)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/TraitPillowStrange.cs#L33)
```cs:line-numbers=33
...
[`@@ -266,6 +266,33 @@ public void Activate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Widget.cs#L266)
```cs:line-numbers=266
		{
...
[`@@ -199,27 +199,6 @@ public Widget ActivateWidget(string id)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/WidgetManager.cs#L199)
```cs:line-numbers=199
		{
...
[`@@ -890,10 +890,6 @@ public void Activate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Zone.cs#L890)
```cs:line-numbers=890
				}
				card.SetInt(55);
			}
...
[`@@ -28,7 +28,17 @@ public override float ChanceSpawnNeutral`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/99cae949d6838b355865ee4daa14f5c969561b55/Elin/Zone_Field.cs#L28)
```cs:line-numbers=28
		}
	}

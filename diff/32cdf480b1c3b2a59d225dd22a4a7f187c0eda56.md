...
[`@@ -517,6 +517,7 @@ public static bool DamageEle(Card CC, EffectId id, int power, Element e, List<Po`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/ActEffect.cs#L517)
```cs:line-numbers=517
			}
...
[`@@ -824,7 +824,7 @@ void func()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/ActPlan.cs#L824)
```cs:line-numbers=824
		{
			showOrder = true;
		}
...
[`@@ -1508,8 +1508,8 @@ public Chara Duplicate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/Chara.cs#L1508)
...
[`@@ -1,3 +1,7 @@`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/ContentConfigOther.cs#L1)
```cs:line-numbers=1
using System; // [!code ++]
...
[`@@ -20,6 +24,8 @@ public class ContentConfigOther : ContentConfig`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/ContentConfigOther.cs#L20)
```cs:line-numbers=20
...
[`@@ -92,6 +98,7 @@ public override void OnInstantiate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/ContentConfigOther.cs#L92)
```cs:line-numbers=92
...
[`@@ -133,12 +140,37 @@ public void OpenBackerCodeInput()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/ContentConfigOther.cs#L133)
```cs:line-numbers=133
				{
...
[`@@ -1856,7 +1856,14 @@ public static string SetElement(string alias, int value, int potential = 100)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/CoreDebug.cs#L1856)
...
[`@@ -2115,7 +2122,7 @@ public static string LastWish(string name)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/CoreDebug.cs#L2115)
...
[`@@ -52,11 +52,6 @@ public void OnClaimLand()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/DramaOutcome.cs#L52)
```cs:line-numbers=52
...
[`@@ -65,7 +65,7 @@ public class FEAT`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/FEAT.cs#L65)
```cs:line-numbers=65
...
[`@@ -103,7 +103,7 @@ public class FEAT`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/FEAT.cs#L103)
```cs:line-numbers=103
...
[`@@ -228,9 +228,9 @@ public class FEAT`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/FEAT.cs#L228)
```cs:line-numbers=228
...
[`@@ -437,6 +437,10 @@ public void OnLoad()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/Game.cs#L437)
```cs:line-numbers=437
			}
		}
	});
...
[`@@ -291,14 +291,17 @@ public override void FixedUpdate()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/GameUpdater.cs#L291)
```cs:line-numbers=291
...
[`@@ -53,5 +53,11 @@ public override void OnProcess(Thing t)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/InvOwnerHotbar.cs#L53)
```cs:line-numbers=53
		{
...
[`@@ -176,6 +176,8 @@ public void SetBaseRoom(Room r)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/Lot.cs#L176)
```cs:line-numbers=176
		{
...
[`@@ -6,9 +6,9 @@ public class MUTATION`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/MUTATION.cs#L6)
```cs:line-numbers=6
...
[`@@ -16,7 +16,7 @@ public class MUTATION`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/MUTATION.cs#L16)
```cs:line-numbers=16
...
[`@@ -78,7 +78,7 @@ public class MUTATION`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/MUTATION.cs#L78)
```cs:line-numbers=78
...
[`@@ -407,6 +407,18 @@ public bool magicChestSent`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/Player.cs#L407)
```cs:line-numbers=407
			}
		}
...
[`@@ -157,6 +157,8 @@ public void Refresh()`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/Room.cs#L157)
```cs:line-numbers=157
		{
...
[`@@ -118,7 +118,7 @@ public class SKILL`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/SKILL.cs#L118)
```cs:line-numbers=118
...
[`@@ -130,7 +130,7 @@ public class SKILL`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/SKILL.cs#L130)
```cs:line-numbers=130
...
[`@@ -269,8 +269,8 @@ public class SKILL`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/SKILL.cs#L269)
```cs:line-numbers=269
...
[`@@ -38,10 +38,10 @@ public class SPELL`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/SPELL.cs#L38)
```cs:line-numbers=38
...
[`@@ -56,10 +56,10 @@ public class SPELL`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/SPELL.cs#L56)
```cs:line-numbers=56
...
[`@@ -72,10 +72,10 @@ public class SPELL`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/SPELL.cs#L72)
```cs:line-numbers=72
...
[`@@ -186,7 +186,7 @@ public class SPELL`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/SPELL.cs#L186)
```cs:line-numbers=186
...
[`@@ -210,10 +210,10 @@ public class SPELL`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/SPELL.cs#L210)
```cs:line-numbers=210
...
[`@@ -234,11 +234,13 @@ public class SPELL`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/SPELL.cs#L234)
```cs:line-numbers=234
...
[`@@ -288,13 +290,13 @@ public class SPELL`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/SPELL.cs#L288)
```cs:line-numbers=288
...
[`@@ -344,14 +346,12 @@ public class SPELL`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/SPELL.cs#L344)
```cs:line-numbers=344
...
[`@@ -388,11 +388,13 @@ public class SPELL`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/SPELL.cs#L388)
```cs:line-numbers=388
...
[`@@ -400,28 +402,29 @@ public class SPELL`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/SPELL.cs#L400)
```cs:line-numbers=400
...
[`@@ -377,7 +377,7 @@ public override void OnCreateProgress(Progress_Custom p)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/TaskHarvest.cs#L377)
```cs:line-numbers=377
...
[`@@ -400,6 +400,10 @@ public DestData GetDest(Thing t, bool tryStack = true)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/ThingContainer.cs#L400)
```cs:line-numbers=400
...
[`@@ -2489,7 +2489,7 @@ public Chara SpawnMob(Point pos = null, SpawnSetting setting = null)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/Zone.cs#L2489)
...
[`@@ -2499,7 +2499,7 @@ public Chara SpawnMob(Point pos = null, SpawnSetting setting = null)`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/Zone.cs#L2499)
...
[`@@ -1,19 +1,9 @@`](https://github.com/Elin-Modding-Resources/Elin-Decompiled/blob/32cdf480b1c3b2a59d225dd22a4a7f187c0eda56/Elin/Zone_DungeonPuppy.cs#L1)
```cs:line-numbers=1

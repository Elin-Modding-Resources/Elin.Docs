...
**モデル**：`deepseek-ai/deepseek-v4-flash`<C prev />  
（または [NVIDIA モデル一覧](https://docs.api.nvidia.com/nim/reference/deepseek-ai-deepseek-v4-flash) に掲載されている他のモデル）
...
Ollama: `http://localhost:11434/v1`<C prev />

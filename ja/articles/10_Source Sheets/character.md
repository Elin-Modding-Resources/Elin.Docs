...
ポートレートの詳細は、[ポートレート](../15_Texture%20Mods/portraits)に移動し、キャラクターModのポートレートのセクションをお読みください。
...
詳細は、メニューの `テクスチャMOD` セクションに移動してお読みください。<!--Menu=总目录=メニュー。Texture Mods=贴图模组=テクスチャMOD--> 

...
你可以**验证完整性**来强制更新Elin文件与mod。即使你设置了自动更新，steam也可能没有更新的你的mod，或者可能更新时缺少文件，这可能导致bug。

验证完整性的操作：
1. 关闭游戏
2. steam内 `右键Elin游戏-属性-已安装文件-验证完整性`

待进度条彻底完成，游戏与mod便更新到了最新版本。有奇怪的bug时，第一步便应该验证完整性。

### 制作mod

#### ModMaker

你可以使用[ModMaker](https://modmaker.elin-modding.net/)来制作mod。目前ModMaker功能如下：
+ 制作新角色
+ 编写剧情
+ 新种族
+ 新职业（job）

注意：你应当在安装了Elin的电脑端，使用ModMaker。

#### 手动填写源表

目前ModMaker有局限性，当它有问题或者功能不足时，你可以手动填写源表。

详情请移步[新手指南：填表制作 Elin 模组](../2_Getting%20Started/sourcesheet_setup.md)

你也可以阅读总目录的 `制作源表模组` 分区的文章。

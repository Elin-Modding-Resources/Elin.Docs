...
**模型**：`deepseek-ai/deepseek-v4-flash`<C prev />  
（或其他可在 [NVIDIA 模型列表](https://docs.api.nvidia.com/nim/reference/deepseek-ai-deepseek-v4-flash) 中找到的模型）
...
可选参数：查看 [DeepSeek API 文档](https://api-docs.deepseek.com/zh-cn/api/create-chat-completion)
